...
function () {
  ...
  _createClass(executeRequest, [{
    ...
    key: "start_call",
    value: function start_call() {
      var api_key, config, r;
      return regeneratorRuntime.async(function start_call$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              api_key = this.apikey === undefined ? "ei-pI8k0CvfPJQLOwOyUoKldwOiO49bnEegbWcML1UTfgf6fHut5S" : this.apikey;
              config = {
                method: "POST",
                url: "https://ai-insight.etpbx.com/api-gateway/gateway/start",
                data: this.getData,
              ...
              _context6.next = 4;
              return regeneratorRuntime.awrap((0, _axios["default"])(config));

            case 4:
              r = _context6.sent;
              return _context6.abrupt("return", r.data.details);
