              ...
              Delete
                          ...
                          >
                            ...
                            <v-btn
                              v-if="CheckUserActions(user_actions.delete)"
                              style="width: fit-content"
                              class="undeline-hover text-capitalize font-weight-light pa-0"
                              color="primary"
                              density="compact"
                              @click.stop
                              @click="modalDelete(s.id, s.intent, i)"
    ...
    <v-card>
      ...
      <v-card-text>
        <v-row>
          <v-col cols="12">
            <v-textarea
              v-model="summary_details.notesConfig.initial_prompt"
              label="Custom Prompt"
              variant="outlined"
              placeholder="Insert text here..."
            ></v-textarea>
          ...
          <v-col cols="12">
            <v-combobox
              ...
              label="Filters"
              variant="outlined"
              v-model="summary_details.notesConfig.filters"
              :hide-no-data="true"
            >
            </v-combobox>
          </v-col>
