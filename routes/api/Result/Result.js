...
const Result = (app, opts, done) => {
  ...
  app.get("/checkIfContainSchema/getByGroup", checkIfContainSchema);
  app.get("/checkIfContainSchema/getByOrganization", checkIfContainSchema);
  app.get("/checkIfContainSchema/getByAgent", checkIfContainSchema);
