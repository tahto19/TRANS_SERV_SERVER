...
class getOrg {
  ...
  getPromptGeneratorAPIkey() {
    let a = (this.access = this.orgDetails.ApiKeys.find((x) => {
      let newName = x.name.toLowerCase().replace(/\s/g, "");
      console.log(newName, "12312312");
      return newName === "promptgenerator";
    }));
    // console.log(this.orgDetails);
    return a === undefined ? false : a.api_key;
  }
  // getOrgServices(data) {
  //   if (this.error) return "error";
  //   else if (data !== undefined) {
