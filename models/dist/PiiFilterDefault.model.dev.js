...
var PiiFilterDefault =
/*#__PURE__*/
function (_Model) {
  _inherits(PiiFilterDefault, _Model);

  function PiiFilterDefault() {
    _classCallCheck(this, PiiFilterDefault);

    return _possibleConstructorReturn(this, _getPrototypeOf(PiiFilterDefault).apply(this, arguments));
  }

  return PiiFilterDefault;
}(_sequelize.Model);
