...
/*#__PURE__*/
function (_Model) {
  _inherits(NotesSummaryD, _Model);

  function NotesSummaryD() {
    _classCallCheck(this, NotesSummaryD);

    return _possibleConstructorReturn(this, _getPrototypeOf(NotesSummaryD).apply(this, arguments));
  }

  return NotesSummaryD;
}(_sequelize.Model);
